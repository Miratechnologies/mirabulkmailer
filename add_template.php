   ...
   <main class="row no-gutters">
      ...
      <aside class="offset-8 position-fixed col-lg-4 bg-light h-100 p-3 pb-5 mb-5 scrollable" style="width: 40%; height: 90%;">
         ...
         <div id="create-new-template">
            ...
            <form method="post" id="templateForm" action="add_template.php">
               <label for="template_type" class="text-lg">Template Type:</label>
               ...
               <textarea id="template_description" name="template_description" minlength="1" maxlength="200" class="form-control" cols="30" rows="3" style="resize:none"></textarea>

               <input type="hidden" name="email_body" id="email_body" value="">
               <input type="hidden" name="submit_add_template" value="Save Template">

               <div id="sms_save">
                  <br>
                  <label for="sms_body" class="text-lg">SMS Template:</label>
                  <textarea onkeyup="$('#sms_body_len').html(160 - $('#sms_body').val().length);" minlength="1" maxlength="160" name="sms_body" id="sms_body" class="form-control" cols="30" rows="5" style="resize:none" ></textarea>
                  <p id="sms_body_len">160</p>

                  <input type="submit" id="submit_add_template" name="submit_add_template" value="Save Template" class="btn btn-md btn-dark" />
               </div>
            </form>
